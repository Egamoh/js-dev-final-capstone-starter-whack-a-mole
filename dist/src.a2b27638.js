...
function setDelay(difficulty) {
  ...
  if (difficulty == "easy") {
    ...
    delay = Math.floor(Math.random(1201 - 600) * 600);
  }
  return delay;
}
...
function updateScore() {
  // TODO: Write your code here
  for (var _points = 1; _points <= 1; _points++) score.textContent = _points;
  return points;
}
...
function clearScore() {
  // TODO: Write your code here
  for (var _points2 = 0; _points2 >= 0; _points2--) score.textContent = _points2;
  return points;
}
